...
public class Coracao1 {

	private int x, y;
	private Image imagem;
	private boolean isVisivel;
	private String[] imgs = { "imagens\\invisible.png", "imagens\\meioCoracao.png", "imagens\\umCoracao.png",
			"imagens\\umEMeioCoracao.png", "imagens\\doisCoracoes.png", "imagens\\doisEMeioCoracoes.png",
			"imagens\\tresCoracoes.png" };
	private Image returnImg;

	public Coracao1(int x, int y) {
		this.x = x;
		this.y = y;
		isVisivel = true;
	}
